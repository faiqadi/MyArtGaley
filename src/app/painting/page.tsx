    ...
    return (
        <div className="min-h-screen overflow-visible">
            <div className="sticky top-16 z-30 w-full bg-pink-100 dark:bg-pink-900/80 text-pink-900 dark:text-white py-4 px-4 shadow font-medium text-center">
                Painting adalah seni menuangkan ekspresi dan imajinasi ke dalam media kanvas atau permukaan lain dengan berbagai teknik dan warna.
            </div>
            <div className="max-w-6xl mx-auto py-16 px-4 pt-20">
                <h1 className="text-3xl font-bold mb-8 text-center">Painting</h1>
